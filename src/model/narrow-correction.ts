...
// Additive export: the new language-agnostic reviewer lives separately so the
// legacy Spanish helper above keeps its existing signature and behaviour.
export { contextualProseCorrection } from "./prose-review.js";
